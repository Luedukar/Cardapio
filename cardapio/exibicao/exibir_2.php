...
if ($result->num_rows > 0) {
    ...
    $destaques .= "<div class='function-container'>";  
    $destaques .= "<a class='function-container' href='config/editarItem.php?id=" . $row["id"] . "'>Editar</a>";
    $destaques .= "<a class='function' href='config/excluir.php?id=" . $row["id"] . "'>Excluir</a>";
    $destaques .= "</div>";  
    $destaques .= "</div>"; 
    ...
    $novos .= "<div class='function-container'>";  
    $novos .= "<a class='function-container' href='config/editarItem.php?id=" . $row["id"] . "'>Editar</a>";
    $novos .= "<a class='function' href='config/excluir.php?id=" . $row["id"] . "'>Excluir</a>";
    $novos .= "</div>";  
    $novos .= "</div>"; 
    ...
    $acompanhamentos .= "<div class='function-container'>";
    $acompanhamentos .= "<a class='function-container' href='config/editarItem.php?id=" . $row["id"] . "'>Editar</a>";
    $acompanhamentos .= "<a class='function' href='config/excluir.php?id=" . $row["id"] . "'>Excluir</a>";
    $acompanhamentos .= "</div>"; 
    ...
    $pratos .= "<div class='function-container'>"; 
    $pratos .= "<a class='function-container' href='config/editarItem.php?id=" . $row["id"] . "'>Editar</a>";
    $pratos .= "<a class='function' href='config/excluir.php?id=" . $row["id"] . "'>Excluir</a>";
    $pratos .= "</div>";  
    $pratos .= "</div>"; 
    ...
    $bebidas .= "<div class='function-container'>";
    $bebidas .= "<a class='function-container' href='config/editarItem.php?id=" . $row["id"] . "'>Editar</a>";
    $bebidas .= "<a class='function' href='config/excluir.php?id=" . $row["id"] . "'>Excluir</a>";
    $bebidas .= "</div>";  
    $bebidas .= "</div>"; 
    ...
    $sobremesas .= "<div class='function-container'>";  
    $sobremesas .= "<a class='function-container' href='config/editarItem.php?id=" . $row["id"] . "'>Editar</a>";
    $sobremesas .= "<a class='function' href='config/excluir.php?id=" . $row["id"] . "'>Excluir</a>";
    $sobremesas .= "</div>";  
    $sobremesas .= "</div>"; 
